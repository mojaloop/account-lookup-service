...
exports.up = (knex, Promise) => {
  return knex.schema.hasTable('centralSwitchEndpoint').then(function (exists) {
    if (!exists) {
      return knex.schema.createTable('centralSwitchEndpoint', (t) => {
        t.increments('centralSwitchEndpointId').primary().notNullable()
        t.string('name')
...
exports.down = function (knex, Promise) {
  return knex.schema.dropTableIfExists('centralSwitchEndpoint')
}
