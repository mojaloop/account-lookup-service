...
module.exports = {
  ...
  put: function (context, request, h) {
    const error = ErrorHandler.Factory.createFSPIOPError(ErrorHandler.Enums.FSPIOPErrorCodes.NOT_IMPLEMENTED)
    return h.response(error.toApiErrorObject()).code(error.httpStatusCode)
  }
}
