 ...
 */
test('test ParticipantsByTypeAndID get operation', async function (t) {
    ...
    const options = {
        method: 'get',
        url: '/participants/MSISDN/12345', // mock.request.path,
 ...
 */
test('test ParticipantsByTypeAndID3 put operation', async function (t) {
    const server = await Server.createServer(t.context);
 ...
 * responses: 202, 400, 401, 403, 404, 405, 406, 501, 503
 */
test('test ParticipantsByIDAndType post operation', async function (t) {
    const server = await Server.createServer(t.context);
 ...
 * responses: 202, 400, 401, 403, 404, 405, 406, 501, 503
 */
test('test ParticipantsByTypeAndID2 delete operation', async function (t) {
    const server = await Server.createServer(t.context);
