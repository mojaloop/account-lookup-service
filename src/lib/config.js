...
const config = {
  ...
  JWS_VALIDATE: RC.ENDPOINT_SECURITY.JWS.JWS_VALIDATE,
  JWS_VERIFICATION_KEYS_DIRECTORY: RC.ENDPOINT_SECURITY.JWS.JWS_VERIFICATION_KEYS_DIRECTORY,
  JWS_VALIDATE_PUT_PARTIES: RC.ENDPOINT_SECURITY.JWS.JWS_VALIDATE_PUT_PARTIES,
  ...
  DELETE_PARTICIPANT_VALIDATION_ENABLED: RC.DELETE_PARTICIPANT_VALIDATION_ENABLED ?? true,
